...
namespace NativeWifi
{
	...
	public class WlanClient : IDisposable
	{
		...
		public class WlanInterface
		{
			...
			// NativeWifi.WlanClient.WlanInterface
			public bool MediaStreamingMode
			{
				get
				{
					return this.GetInterfaceInt ( Wlan.WlanIntfOpcode.MediaStreamingMode ) != 0;
				}
				set
				{
					this.SetInterfaceInt ( Wlan.WlanIntfOpcode.MediaStreamingMode, value ? 1 : 0 );
				}
			}
			...
			public bool BackgroundScanEnabled
			{
				get
				{
					return this.GetInterfaceInt ( Wlan.WlanIntfOpcode.BackgroundScanEnabled ) != 0;
				}
				set
				{
					this.SetInterfaceInt ( Wlan.WlanIntfOpcode.BackgroundScanEnabled, value ? 1 : 0 );
				}
			}
